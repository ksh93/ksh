...
#endif'
		ERROR - $'iffe: test: is _XXX_stdio.h a header ... no
iffe: test: is limits.h a header ... yes'
...
#endif'
		ERROR - 'iffe: test: long int type ... yes'
...
#endif'
		ERROR - $'iffe: test: is t.h a header ... yes
...
#endif'
		ERROR - $'iffe: test: is int a reserved keyword ... yes
...
#endif'
		ERROR - $'iffe: test: is ( bar_foo ) true ... no
...
#endif'
		ERROR - $'iffe: test: is ( bar_foo ) true ... yes'

...
{ errors=$("$SHELL" -xc 'unset "$@"; ./unset_execute_test "$@"' unset_execute_test \
	PS2 IFS PWD SHELL MAILCHECK RANDOM ENV FCEDIT PS3 PPID _ TMOUT SECONDS LINENO OPTIND PS4 KSH_VERSION \

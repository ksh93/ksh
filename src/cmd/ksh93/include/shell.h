...
extern const char 	e_negative_flt[];
extern const char 	e_outofrange[];
extern const char 	e_outofrange_flt[];
extern const char 	e_outofrange_uid[];
...
extern void 		sh_delay(Sfdouble_t,int);

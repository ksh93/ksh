...
const char e_histtemp[]		= "temporary history file `%s' is left";
...
const char e_negative_flt[]	= "%I*f: cannot accept negative numbers";
const char e_outofrange[]	= "%s: out of range";
const char e_outofrange_flt[]	= "%I*f: out of range";
const char e_outofrange_uid[]	= "%s: UID is out of range";
...
const char e_badrange2[]	= "%s: given range is itself out of range";
